...
import { updateTweetLikes, addCommentToTweet as addCommentToPost } from '../config/firebaseService';
...
const ViewPost = ({ route }) => {
    ...
    const handleLike = () => {
        ...
        updateTweetLikes(currentPost.id, updatedLikes)
            .catch(err => {
                console.error("Error while saving the Like: ", err);
            });
    };
    ...
    const handleAddComment = () => {
        ...
        addCommentToPost(currentPost.id, comment)
            .catch(err => {
                console.error("Error while saving the comment: ", err);
            });
    };
